...
/*renamed the discsfixtures with basefixtures but didnt test*/class BaseFixtures extends Fixture
//  class DiscsFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($artist as $art){
            $artistDB = new Artist();
            $artistDB
            // ->setId($art['artist_id'])  we took in comments because it is an auto-incrementing primary key,shouldn't set it manually
